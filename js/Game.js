class Game {
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        //save the value of player.life in a temporary variable
        ...
        //checks for the active window/player
  ...
  showLeaderboard() {
    ...
    if (
      ...
      console.log("inside leader 1 display")
    ...
    if (players[1].rank === 1) {
      console.log("inside leader 2 display")
      leader1 =
        players[1].rank +
        "&emsp;" +
        players[1].name +
